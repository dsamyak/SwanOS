/* ============================================================
 * SwanOS — Interrupt Descriptor Table
 * Sets up the IDT, remaps the PIC, and handles ISR/IRQ dispatch.
 * ============================================================ */
...
/* Called by isr_common_stub in assembly */
...
/* Called by irq_common_stub in assembly */
